...
> Every game, your tech tree is different. Macro like normal SC2, but your Barracks/Factory/Starport roll random units from all races each tier plus matching upgrades. Curated, not chaos: no Marines with Disruptor shots. Discord: https://discord.gg/hdT6FCyM
...
**Length:** 255 chars — deliberately kept **under** the previous 285-char description (which was near the in-client cap). First draft (417) was too long; trimmed to c2.
