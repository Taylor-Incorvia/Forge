...
Every unit's **rollable upgrade pool**, derived from the eligibility tags in `upgradeInitializers.galaxy` (see `docs/upgrade-eligibility-tags.md` for the rules). Snapshot 2026-07-23 (post WA-034/WA-049 + WA-052–WA-058, WA-063, + the 07-23 balance pass) — regenerate after changing pools or tags. `[n]` = number of eligible upgrades (pool membership). WA-049 caps then limit how many of a player's units may actually **roll** the same upgrade in one game — see note below.
...
BARRACKS
 ...
 s1  Zealot        [5]  Blink, HotSRaptorCharge2, Charge, Stimpack, ConcussiveZealot
 ...
 s4  Ghost        [14]  BlindingCloud, BuildAutoTurret, FungalGrowth, Irradiate, NeuralParasite, ParasiticBomb, RavenScramblerMissile, SeekerMissile, Yoink, Blink, Range, Speed, Stimpack, PersonalCloaking
 s4  Infestor      [8]  ArbiterMPRecall, BlindingCloud, BuildAutoTurret, Irradiate, ParasiticBomb, RavenScramblerMissile, SeekerMissile, Yoink
 s4  HighTemplar  [10]  ArbiterMPRecall, BlindingCloud, BuildAutoTurret, FungalGrowth, Irradiate, NeuralParasite, ParasiticBomb, RavenScramblerMissile, SeekerMissile, Yoink
FACTORY
...
STARPORT
 ...
 s3  Raven         [8]  ArbiterMPRecall, BlindingCloud, FungalGrowth, Irradiate, NeuralParasite, ParasiticBomb, SeekerMissile, Yoink
 s3  Tempest       [5]  Blink, Stimpack, Yamato, TempestRange, Hyperjump
 s3  Viper         [7]  ArbiterMPRecall, BuildAutoTurret, FungalGrowth, Irradiate, NeuralParasite, RavenScramblerMissile, SeekerMissile
...
**`[5]`: Zealot · Hydralisk · Marine · Medic · Immortal · Goliath · Vulture · Tempest · Battlecruiser**
...
_**Balance pass (2026-07-23):** Disruption Web is now low-tier only — pulled off Barracks s4 (Ghost/Infestor/HighTemplar) and Starport s3 (Raven/Viper); still rolls on Queen/Sentry/Medic/Phoenix/Wraith · Zealot no longer rolls `zerglingattackspeed` (unnoticeable on its long attack animation). Non-pool tuning also shipped: Irradiate energy 25→40, Armory cost 150/50→150/75._
